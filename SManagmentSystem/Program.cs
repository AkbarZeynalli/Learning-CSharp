using SManagmentSystem.Services;

namespace SManagmentSystem
{
    internal class Program
    {
        ...
        static void TopicMenu()
        {
            ...
            do
            {
                ...
                Console.WriteLine("2. Get Topic by ID");
                Console.WriteLine("3. Update Topic");
                Console.WriteLine("4. Delete Topic");
                Console.WriteLine("5. Get All Topics");
                Console.WriteLine("6. Back to Main Menu");
                Console.Write("Enter your choice: ");
                if (!int.TryParse(Console.ReadLine(), out topicChoice))
                {
                    Console.WriteLine("Invalid input. Please enter a number.");
                    continue;
                }
                ...
                {
                    case 1:
                        operationManagment.AddTopic();
                        break;
                    case 2:
                        operationManagment.GetTopic();
                        break;
                    case 3:
                        operationManagment.UpdateTopic();
                        break;
                    case 4:
                        operationManagment.DeleteTopic();
                        break;
                    case 5:
                        operationManagment.GetAllTopics();
                        break;
                    case 6:
                        Console.WriteLine("Returning to Main Menu...");
                        break;
